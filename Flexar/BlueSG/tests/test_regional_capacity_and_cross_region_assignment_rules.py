...
from Flexar.BlueSG.build_optimised_vehicle_routes import RiderState, TravelCost, optimise_vehicle_routes
...
def _patch_travel(monkeypatch) -> None:
    ...
    monkeypatch.setattr("Flexar.BlueSG.build_optimised_vehicle_routes.get_empty_travel_cost", empty)
    monkeypatch.setattr("Flexar.BlueSG.build_optimised_vehicle_routes.get_travel_cost", loaded)
